    ...
    stages {
        ...
        stage('2.Compile') {  // Second stage: Compile the application
            ...
            steps {
                ...
                sh 'cd ${WS} && npm install --registry=https://registry.npmmirror.com --no-fund --legacy-peer-deps && npm run build'  // Navigate to workspace, install dependencies, and build the project
            }
        }
